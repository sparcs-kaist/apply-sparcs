      ...
      <div class="container">
        <div class="columns is-centered is-vcentered">
          <div class="column is-half has-text-centered">
            ...
            />
            <h2 class="subtitle is-4">2025년도 가을학기 SPARCS 리크루팅</h2>
            <br />
            <div class="notification is-danger has-text-left">
              내부 상황에 따라 리크루팅 일정이 변동될 수 있습니다.
              <br />변동 시 SPARCS 공식 홈페이지 및 페이스북, 인스타그램을 통해
              알려드리겠습니다.
              <br /><u>2025년 9월 1일 오후 7시 ~ 오후 8시 30분과 2025년 9월 2일 오후 7시 ~ 오후 9시</u>에 진행되는 오픈동방에 참여하시면 동방을 구경하면서 현역 회원과 이야기를 나눠보실 수 있습니다.
              <br /><a href="https://url.kr/vw9q99">FAQ 바로가기</a>
            </div>
            <div class="notification has-text-left">
              <template v-if="!overdue">
                {{ dueText }}에 2025년도 가을학기 SPARCS 리크루팅 지원서 작성이
                마감됩니다.
              </template>
              <template v-else>
                2025년도 가을학기 SPARCS 리크루팅 준비중입니다.
              </template>
            </div>
            <hr />
            <button
