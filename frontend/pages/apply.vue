          ...
          <form ref="form" class="column is-half" @submit.prevent="submitForm">
            ...
            <div class="form-item">
              <p class="form-desc">
                ...
                <br />
                <a href="https://calendly.com/kwabang-sparcs/2026-fall-sparcs-recruit" target="_blank">면접 가능 시간 입력</a>
                <p class="comment">
                <br />
                *) 직군 별로 면접 가능 시간이 상이하니, 지원하고자 하는 직군의 면접 가능 시간을 반드시 확인 후 신청해주세요.
                <br />
                **) 남아있는 시간대 중 대면 면접이 가능한 시간이 없거나, 링크를 통해 면접 일정을 신청하는데 어려움이 있다면 staff@sparcs.org 으로 문의 부탁드립니다.
                </p>
                <br />
                면접 가능 시간을 입력하셨나요?
              </p>
